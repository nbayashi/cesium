...
define(['./when-9f8cafad', './Cartesian2-ea36f114', './Check-c23b5bd5', './EllipsoidGeometry-8fb6a6ac', './VertexFormat-acf66ec0', './Math-cf2f57e0', './GeometryOffsetAttribute-a43cd3fe', './Transforms-0a60c469', './RuntimeError-40167735', './ComponentDatatype-ec57da04', './WebGLConstants-daaa9be0', './GeometryAttribute-abbafb10', './GeometryAttributes-fcb70320', './IndexDatatype-d65a2d74'], function (when, Cartesian2, Check, EllipsoidGeometry, VertexFormat, _Math, GeometryOffsetAttribute, Transforms, RuntimeError, ComponentDatatype, WebGLConstants, GeometryAttribute, GeometryAttributes, IndexDatatype) { 'use strict';
